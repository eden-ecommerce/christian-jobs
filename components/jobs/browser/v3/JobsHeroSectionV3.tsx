...
import type { JobsHeroSearchSubmit } from "@lib/jobs/search-params";
...
export function JobsHeroSectionV3({ onSearch }: Props) {
  return (
    <section className="relative overflow-hidden bg-[#fbfbfd]">
      ...
      <div className="relative mx-auto max-w-screen-2xl px-4 sm:px-6 lg:mx-0 lg:max-w-none lg:px-0">
        <div className="relative grid items-center gap-5 py-6 sm:gap-6 sm:py-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-10 lg:h-[calc(100svh-56px-128px)] lg:min-h-0 lg:py-6 xl:gap-14">
          <div className="relative z-10 min-w-0 w-full lg:pl-8 xl:pl-12 2xl:pl-16">
            <div className="max-w-xl lg:max-w-[540px] xl:max-w-[580px]">
              ...
              <p className="mt-3 max-w-md text-[18px] leading-relaxed text-[#6e6e73] sm:text-[19px] sm:leading-[1.45]">
            ...
            <div className="mt-6 w-full sm:mt-7">
              <JobsHeroSearchV3 onSearch={onSearch} location="" />
            </div>
            ...
            <a
              ...
              className="group mt-4 inline-flex items-center gap-1 text-[15px] font-medium text-[#235A0E] transition-colors hover:text-[#1a4509]"
            >
