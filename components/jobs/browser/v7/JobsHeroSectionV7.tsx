...
import { JobsHeroSearchTabsV7 } from "@components/jobs/browser/v7/JobsHeroSearchTabsV7";
...
/**
 * V7 homepage hero — same v6 card/image, with Category / Location / Work Type tabs.
 */
export function JobsHeroSectionV7({
  categories,
  resultsPath,
  onLocationSearch,
}: Props) {
