...
/**
 * V5 homepage hero — Rightmove-inspired contained card with aerial photography,
 * centred copy, and a focused search panel (taller than Rightmove, not full viewport).
 */
export function JobsHeroSectionV5({ onSearch, onBrowseLatest }: Props) {
