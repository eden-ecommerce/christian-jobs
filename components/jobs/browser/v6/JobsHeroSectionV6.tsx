...
/**
 * V6 homepage hero — category chips (plus Latest) as one-step paths to results.
 * Location and combined filters live on the results page.
 */
export function JobsHeroSectionV6({ categories, resultsPath }: Props) {
